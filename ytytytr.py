...
hf_API_key= "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"
...
def summarize_text(text, min_length, max_length, model_name=DEFAULT_MODEL):
    ...
    if isinstance(result, list) and result and "summary_text" in result[0]:
        ...
        print(Fore.RED + "✖️ Error in summarization response:", result)
        return None
...
if not user_text:
    print(Fore.RED + "✖️ No text provided. Exiting.")
else:
...
if summary:
    ...
    print(Fore.RED + "✖️ Failed to generate summary.")