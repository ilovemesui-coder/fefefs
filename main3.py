...
def get_essay_details():
    ...
    target_audience = input("Target audience (e.g., High school students): ")
...
def generate_essay_content(details):
    ...
    if choice == "1":
        ...
        body_step = generate_response(step_p, temperature=temp,
                              max_tokens=1024)
    ...
    concl_p = f"Write a conclusion for an {details['essay_type']} essay about \
    {details['topic']} with the stance of {details['target_audience']}."
